...
replace github.com/go-gst/go-gst => github.com/livekit/gst-go v0.0.0-20251117112002-0b369ae50ac6
...
require (
	...
	github.com/livekit/psrpc v0.7.1-0.20251101160341-f7f2fe125942
